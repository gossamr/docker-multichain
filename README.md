...
This is the repository for the gossamr/*-multichain docker images, forked from Kunstmaan.

## Images

* [gossamr/base-multichain](https://hub.docker.com/r/gossamr/base-multichain/): A base Ubuntu with the latest Multichain deamon installed
* [gossamr/node-multichain](https://hub.docker.com/r/gossamr/node-multichain/): Based on the same "base" image and connects to the master node

## Running the cluster

Use this [docker-compose.yml](https://github.com/gossamr/docker-multichain/blob/master/docker-compose.yml) and run:
